...
class SegHandler:
    ...
    def scale_from_global_angle(self, x, rw_normal_angle, rw_distance):
        ...
        num = SCREEN_DIST * \
            math.cos(math.radians(rw_normal_angle - x_angle - self.player.angle))
    ...
    def draw_solid_wall_range(self, x1, x2):
        ...
        rw_scale1 = self.scale_from_global_angle(
            x1, rw_normal_angle, rw_distance)
        ...
        if x1 < x2:
            scale2 = self.scale_from_global_angle(
                x2, rw_normal_angle, rw_distance)
        ...
        for x in range(x1, x2 + 1):
            ...
            if b_draw_ceil:
                ...
                renderer.draw_flat(ceil_texture_id, light_level,
                                   x, cy1, cy2, world_front_z1)
            ...
            if b_draw_wall:
                ...
                if wy1 < wy2:
                    ...
                    texture_column = rw_distance * \
                        math.tan(math.radians(angle)) - rw_offset
            ...
            if b_draw_floor:
                ...
                fy2 = lower_clip[x] - 1
                renderer.draw_flat(floor_texture_id, light_level,
                                   x, fy1, fy2, world_front_z2)
        ...
        for x in range(x1, x2 + 1):
            ...
            if b_draw_upper_wall:
                ...
                if b_draw_ceil:
                    ...
                    cy2 = int(min(draw_wall_y1 - 1, lower_clip[x] - 1))
                    renderer.draw_flat(
                        tex_ceil_id, light_level, x, cy1, cy2, world_front_z1)
            ...
            if b_draw_ceil:
                cy1 = upper_clip[x] + 1
                cy2 = int(min(draw_wall_y1 - 1, lower_clip[x] - 1))
                renderer.draw_flat(tex_ceil_id, light_level,
                                   x, cy1, cy2, world_front_z1)
            ...
            if b_draw_lower_wall:
                ...
                if b_draw_floor:
                    ...
                    fy2 = lower_clip[x] - 1
                    renderer.draw_flat(
                        tex_floor_id, light_level, x, fy1, fy2, world_front_z2)
            ...
            if b_draw_floor:
                ...
                fy1 = int(max(draw_wall_y2 + 1, upper_clip[x] + 1))
                fy2 = lower_clip[x] - 1
                renderer.draw_flat(tex_floor_id, light_level,
                                   x, fy1, fy2, world_front_z2)
