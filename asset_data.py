...
class AssetData:
    def __init__(self, wad_data):
        ...
        self.sprites = self.get_sprites(
            start_marker="S_START", end_marker="S_END")
        ...
        if self.get_lump_index("TEXTURE2"):
            texture_maps += self.load_texture_maps(
                texture_lump_name="TEXTURE2")
    ...
    def get_flats(self, start_marker="F_START", end_marker="F_END"):
        ...
        for flat_lump in flat_lumps:
            ...
            flat_data = []
            for i in range(size):
                flat_data.append(self.reader.read_1_byte(
                    offset + i, byte_format="B"))
